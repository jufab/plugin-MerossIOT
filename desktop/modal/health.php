...
<table class="table table-condensed tablesorter" id="table_healthmeross">
    ...
    foreach( $eqLogics as $eqLogic ) {
        ...
        if( file_exists(dirname(__FILE__) . '/../../docs/images/devices/' . $eqLogic->getConfiguration('type') . '.png')) {
            $image = '<img src="plugins/MerossIOT/docs/images/devices/' . $eqLogic->getConfiguration('type') . '.png" height="55" width="55" style="' . $opacity . '" />';
        } else {
